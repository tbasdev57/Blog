// sign up user 
import { readBlogs } from "./store.js";
...
const loginUser = (repeterBox) => {
    const handelLoginGoogleUser = document.querySelector("#loginGoogleId");
    handelLoginGoogleUser.addEventListener("click", (e)=>{signInUserWithGoogle(readBlogs);});
